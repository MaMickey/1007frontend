...
class ProductList extends PureComponent{
    render(){
        const {productList,productAmount,page,wish,priceType,images} = this.props;
        ...
        return (
            <Fragment>
                ...
                <Pagination productAmount={productAmount} page={page} handlePageClick={this.props.handlePageClick}/></div>

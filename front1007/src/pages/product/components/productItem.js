      ...
      <div className="col-md-4 col-lg-3">
        <div className="card card-product-grid productListCard">
          ...
          <div className="info-wrap border-top">
            ...
            {
              Stock > 10&&priceType.priceType==='eBayPrice'? <div>More than 10 left</div>:<div>{Stock} left</div>
            }
          </div>
          {
            this.props.data[`${priceType.priceType}`] === 0||priceType.priceType==='eBayPrice'||this.props.data[`${priceType.priceType}`]===this.props.data.eBayPrice?<div className="productPriceOriginal">AU${this.props.data.eBayPrice}</div>:
            <div>{
              Stock<estimateStock?<div className="productPriceOriginal">AU${this.props.data.eBayPrice}</div>:
              <Fragment><div className="productPriceOriginal">
              <del style={{backgroundColor:"tomato"}}>AU${this.props.data.eBayPrice}</del></div>
